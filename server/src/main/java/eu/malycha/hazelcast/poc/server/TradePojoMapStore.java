...
public class TradePojoMapStore implements MapStore<String, TradePojo>, MapLoaderLifecycleSupport {

    private static final Logger LOGGER = LoggerFactory.getLogger(TradePojoMapStore.class);
